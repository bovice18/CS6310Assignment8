...
public class SimDriver {
    ...
    public static void generateReport() {
    	...
    	try {
    		fileWriter = new FileWriter("/home/student/Desktop/reports/data/vehicles.csv");
    		fileWriter.append("Vehicle Type,id,routeId,passengers,speed");
    		fileWriter.append("\n");
    		
    		for (TransportationVehicle vehicle: martaModel.getVehicles().values()) {
    			fileWriter.append(vehicle.getVehicleType() + ",");
    			fileWriter.append(Integer.toString(vehicle.getID()) + ",");
    			fileWriter.append(Integer.toString(vehicle.getRouteID()) + ",");
    			fileWriter.append(Integer.toString(vehicle.getRiders().size()) + ",");
    			fileWriter.append(Integer.toString(vehicle.getSpeed()));
    			fileWriter.append("\n");
    		}
    	...
    	try {
    		fileWriter = new FileWriter("/home/student/Desktop/reports/data/stops.csv");
    		fileWriter.append("stop name,stop id,waiting");
    		fileWriter.append("\n");
    		
    		for (Stop singleStop: martaModel.getStops().values()) {
    			fileWriter.append(singleStop.getName() + ",");
    			fileWriter.append(Integer.toString(singleStop.getID()) + ",");
    			fileWriter.append(Integer.toString(singleStop.getRiders().size()));
    			fileWriter.append("\n");
    		}
    	...
    	try {
    		Process p = Runtime.getRuntime().exec("python /home/student/Desktop/generate_report.py");
    	}
    	catch (IOException e) {
        ...
        file = new File("/home/student/Desktop/reports/top_15_report.xlsx");
        if(file.exists()) {
        	try {
        		desktop.open(file);
        	}
    ...
    private static void uploadFromFile(String filename) {
    	try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				String output = runCommand(tokens);
			}
			fileReader.close();
		} catch (IOException e) {
			e.printStackTrace();
